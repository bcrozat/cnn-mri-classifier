...
class CNN(nn.Module): # V5
    def __init__(self):
        ...
        self.fc1 = nn.Linear(64*16*16, 1)   # Output a single value for binary classification # Use (256*4*4) for 4 convolutional layers, (128*8*8) for 4, (64*16*16) for 3, (32*32*32) for 2, (16*64*64) for 1
